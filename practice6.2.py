# Question:第六章 练习二 给Image类添加resize方法
# Solution:如果裁剪，重新生成self.color和self.data
# Answer:
"""
...
class Image:
    ...
    def resize(self, width, height):
        if width is None and height is None:
            ...
            height = self.__height if width is None else height
            self.__width = width
            self.__height = height
